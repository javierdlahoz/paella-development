...
class WP_Views{
    ...
    function wpv_frontend_enqueue_scripts() {
		...
		wp_register_script( 'views-pagination-script', WPV_URL_EMBEDDED . '/res/js/wpv-pagination-embedded.js', array('jquery'), WPV_VERSION, true );
...
';
    ...
    */
	...
	function wpv_update_map_plugin_status() {
		...
		$options = $this->get_options();
		$options['wpv_map_plugin'] = $_POST['wpv_map_plugin_status'];
	...
	function wpv_update_debug_mode_status() {
		...
		$options = $this->get_options();
		$options['wpv_debug_mode'] = $_POST['debug_status'];
		$options['wpv-debug-mode-type'] = $_POST['wpv_dembug_mode_type'];
		$this->save_options($options);
		echo 'ok';
		die();
	}
