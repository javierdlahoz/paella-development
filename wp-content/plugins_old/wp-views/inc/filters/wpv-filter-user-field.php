...
if(is_admin()){
	...
	function wpv_add_filter_usermeta_field_list_item($view_settings) {
		if (!isset($view_settings['usermeta_fields_relationship'])) {
			$view_settings['usermeta_fields_relationship'] = 'OR';
		}
		...
		if ($td != '') {
			echo "<li id='js-row-usermeta-field' class='filter-row-multiple js-filter-row js-filter-row-multiple js-filter-for-posts js-filter-usermeta-field js-filter-row-usermeta-field'>";
				echo "<p class='edit-filter js-wpv-filter-edit-controls'>\n<button class='button-secondary edit-trigger js-wpv-filter-edit-open'>".__('Edit','wpv-views')."</button>\n<i class='icon-remove-sign js-filter-usermeta-field-row-remove' data-nonce='". wp_create_nonce( 'wpv_view_filter_usermeta_field_row_delete_nonce' ) . "'></i>\n</p>";
				if ($summary != '') {
					echo "<p class='wpv-filter-edit-summary wpv-filter-usermeta-field-edit-summary js-wpv-filter-summary js-wpv-filter-usermeta-field-summary'>";
					_e('Select users with user fields: ', 'wpv-views');
					echo $summary;
					echo "</p>\n";
				}
				echo "<div id=\"wpv-filter-usermeta-field-edit\" class=\"wpv-filter-edit js-filter-usermeta-field-edit js-wpv-filter-edit\">\n";
				echo $td; ?>
					<div class="wpv-filter-usermeta-field-relationship js-wpv-filter-usermeta-field-relationship-container">
						...
						<p>
							...
							<select name="usermeta_fields_relationship" class="js-wpv-filter-usermeta-fields-relationship">
								...
								<?php $selected = $view_settings['usermeta_fields_relationship']=='AND' ? ' selected="selected"' : ''; ?>
