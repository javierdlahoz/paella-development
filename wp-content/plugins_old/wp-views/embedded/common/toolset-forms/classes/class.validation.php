...
class WPToolset_Forms_Validation
{
    ...
    function __construct( $formID ){
        ...
        // Render settings
        add_action( 'admin_print_footer_scripts', array($this, 'renderJsonData'), 20 );
        add_action( 'wp_footer', array($this, 'renderJsonData'), 20 );
...
//            unset( $rule['message'] );
     ...
     * @return type
     */
    public function filterFormSubmit( $form ) {
