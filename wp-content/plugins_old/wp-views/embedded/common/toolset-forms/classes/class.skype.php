...
class WPToolset_Field_Skype extends WPToolset_Field_Textfield
{
    ...
    public function metaform() {
        ...
        $form[] = array(
            '#type' => 'markup',
            '#markup' => $this->getButtonImage( $value['skypename'],
                    $value['button_style'], 'js-wpt-skype-preview' ),
        );
        $form[] = array(
            '#name' => '',
            '#type' => 'button',
    ...
    public function editButtonTemplate(){
        $output = '';
        $output .= '<div id="tpl-wpt-skype-edit-button" style="display:none;"><div>';
        $output .= '<input type="textfield" value="" class="js-wpt-skypename">&nbsp;';
        for ( $index = 1; $index < 7; $index++ ) {
            $output .= '<label><input type="radio" name="_js-wpt-skypestyle" value="btn'
                    . $index . '">&nbsp;'
