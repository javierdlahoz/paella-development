    ...
    */
    ...
    function views_settings_admin() { // TODO move to its own file and create own js file too
        ...
        <div class="wrap">
			...
			<?php $this->custom_inner_shortcodes($options); ?>

			<?php $this->show_hidden_custom_fields($options); ?>
			
			<?php $this->wpv_map_plugin($options); ?>
	...
	function custom_inner_shortcodes($options) {
		if (isset($options['wpv_custom_inner_shortcodes']) && $options['wpv_custom_inner_shortcodes'] != '') {
			$custom_shrt = $options['wpv_custom_inner_shortcodes'];
		} else {
			$custom_shrt = array();
		...
		<div class="wpv-setting-container wpv-settings-shortcodes">
			...
			<div class="wpv-setting">
				...
				<p>
					<?php _e('Example: to support [wpv-post-title id="[my-custom-shortcode]"] add <strong>my-custom-shortcode</strong> as a third-party shortcode argument below.', 'wpv-views'); ?>
				</p>
				<div>
    				<ul class="js-custom-shortcode-list">
    				<?php
                    ...
                    <p>
                        ...
                        <div class="js-wpv-debug-additional-options<?php echo empty( $options['wpv_debug_mode'] ) ? ' hidden' : ''; ?>">
							...
							<div class="js-wpv-debug-checker<?php echo $debug_enabled ? '' : ' hidden'; ?>">
								...
								<p class="js-wpv-debug-checker-actions<?php echo ( $debug_dismissed || $debug_tested ) ? ' hidden' : ''; ?>"><button data-target="<?php echo admin_url(); ?>admin.php?page=views-settings-new&amp;action=test-debug&amp;timestamp=<?php echo current_time('timestamp'); ?>#debug_mode" class="js-wpv-debug-checker-action button-primary"><?php _e('Test the debugger window', 'wpv-views'); ?></button> <button href="<?php echo admin_url(); ?>admin.php?page=views-settings-new" class="js-wpv-debug-checker-dismiss button-secondary"><?php _e('It\'s OK, skip this test', 'wpv-views'); ?></button></p>
								
								<p class="js-wpv-debug-checker-enabler<?php echo ( $debug_dismissed && !$debug_tested ) ? '' : ' hidden'; ?>"><a href="<?php echo admin_url(); ?>admin.php?page=views-settings-new" class="js-wpv-debug-checker-recover" title="<?php _e('Test debugger window', 'wpv-views'); ?>"><?php _e('Test debugger window', 'wpv-views'); ?></a></p>
	...
	function wpv_map_plugin($options) {
